...
# IDs da tabela funcionarios Jactos — atualizado 21/08/2026
# LEANDRO OLIVEIRA=102, CICERA KEYLA=93, CARLOS EDUARDO(KADU)=128
# JOHNATHAN FERREIRA=113, KAYO KENNED=82, MEZACK=7, AGUINALDO=3
# WISLEY=115, GRAZIELLA=104, RAFAEL=95, GISELLY=103, CLEUBER=8
TECNICOS_IDS = (102, 93, 128, 113, 82, 7, 3, 115, 104, 95, 103, 8)
